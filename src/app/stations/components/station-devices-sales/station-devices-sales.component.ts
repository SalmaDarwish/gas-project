...
@Component({
  selector: 'app-station-devices-sales',
  templateUrl: './station-devices-sales.component.html',
  styleUrls: ['./station-devices-sales.component.scss']
})
export class StationDevicesSalesComponent {
